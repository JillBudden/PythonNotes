##########################################PANDAS TIMESERIES#############################################
# all data and packages can be assumed to be loaded
# pd.to_datetime() function to parse the string into proper datetime elements


#####Creating & Using a Datetime Index#####
